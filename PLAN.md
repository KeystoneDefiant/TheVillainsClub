...
- **Tests / CI:** **Vitest** + **ESLint**; Oubliette tests live under `src/minigames/oubliette-no9/**`; 7 Year Itch engine tests under `src/minigames/seven-year-itch/engine/__tests__/`; Fateseal engine tests under `src/minigames/fateseal-silver/engine/__tests__/`; Masterton engine tests under `src/minigames/masterson-1881/engine/__tests__/`; shell/table helpers under `src/components/club/` and `src/game/`.

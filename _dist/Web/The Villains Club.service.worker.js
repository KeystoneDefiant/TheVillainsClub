...
/** @type {string} */
const CACHE_VERSION = '1775254877|301996685';
/** @type {string} */
const CACHE_PREFIX = 'The Villains Clu-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'The Villains Club.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["The Villains Club.html","The Villains Club.js","The Villains Club.offline.html","The Villains Club.icon.png","The Villains Club.apple-touch-icon.png","The Villains Club.worker.js","The Villains Club.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["The Villains Club.wasm","The Villains Club.pck"];

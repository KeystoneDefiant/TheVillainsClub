...
- **Tuning:** **`npm run sim:fateseal`** runs the Fateseal Silver Monte Carlo harness (`scripts/sim-fateseal.ts`; requires **`tsx`** from devDependencies).
